                                    ...
                                    <table class="table table-editable table-nowrap align-middle table-edits">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($celebsList as $key => $celeb)
                                                ...
                                                <div class="modal fade bs-example-modal-center" id="editModal{{ $celeb->id ?? 'nil' }}" tabindex="-1" role="dialog" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{ route('celebs.update', $celeb->id ?? 'nil') }}" method="POST" enctype="multipart/form-data">
                                                                    @csrf
                                                                     @method('PUT')
                                                                    <div class="mb-3">
                                                                        <label for="formrow-firstname-input" class="form-label">Full Name</label>
                                                                        <input type="text" name="fullname" class="form-control"
                                                                            id="formrow-firstname-input" value="{{ $celeb->fullname ?? 'nil' }}">
                                                                    </div>
                                                                                ...
                                                                                <div class="docs-datepicker">
                                                                                    <div class="input-group">
                                                                                        <input type="date" class="form-control docs-date"
                                                                                            name="date_of_birth" value="{{ $celeb->date_of_birth ?? 'nil' }}"
                                                                                            autocomplete="off">
                                                                                    </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <select id="formrow-inputState" class="form-select" name="gender">
                                                                                    <option>{{$celeb->gender ?? 'nil'}}</option>
                                                                                    <option>M</option>
                                                                                    <option>F</option>
                                                                                </select>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <select id="formrow-inputState" class="form-select" name="country">
                                                                                    <option selected>{{$celeb->country ?? 'nil'}}</option>
                                                                                    @foreach ($countries as $countryName)
                                                                                        <option>{{ $countryName ?? 'nil'}}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-6">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input type="text" class="form-control" name="category"
                                                                                    id="formrow-firstname-input" value="{{ $celeb->category ?? 'nil'}}">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <div>
                                                                                <input required class="form-control" value="{{ $celeb->bio ?? 'nil'}}" name="bio">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="mb-3 col-lg-12">
                                                                            <label for="resume">Current Image: {{ $celeb->img ?? 'nil'}}</label>
                                                ...
                                                <div class="modal fade" id="deleteModal{{ $celeb->id ?? 'nil'}}">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p>Are you sure you want to delete {{ $celeb->fullname ?? 'nil'}}'s profile ?
                                                                </p>
                                                            </div>
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{ route('celebs.destroy', $celeb->id ?? 'nil') }}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
